...
exports.seed = void 0;
const ru = __importStar(__webpack_require__(1691));
const list = [ru];
function seed(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        return list.reduce((prev, { countries, states, cities }) => __awaiter(this, void 0, void 0, function* () {
            yield prev;
            // insert countries
            yield knex.raw(`
...
module.exports = require("@via-profit-services/geography/dist/countries/RU");;
...
/******/ 	return __webpack_require__(61975);
/******/ })()
;